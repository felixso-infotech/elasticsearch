/*
 * package com.felixsoinfotech.SpringbootElasticsearch.config;
 * 
 * import java.io.IOException;
 * 
 * import org.springframework.boot.autoconfigure.data.elasticsearch.
 * ElasticsearchProperties; import
 ...
 * org.springframework.data.elasticsearch.core.EntityMapper; import
 ...
 * com.github.vanroy.springdata.jest.JestElasticsearchTemplate; import
 * com.github.vanroy.springdata.jest.mapper.DefaultJestResultsMapper;
 * 
 * import io.searchbox.client.JestClient;
 * 
 * @Configuration
 * 
 * @EnableConfigurationProperties(ElasticsearchProperties.class) public class
 * ElasticsearchConfiguration {
 * 
 * private ObjectMapper mapper;
 * 
 * public ElasticsearchConfiguration(ObjectMapper mapper) { this.mapper =
 * mapper; }
 * 
 * @Bean public EntityMapper getEntityMapper() { return new
 * CustomEntityMapper(mapper); }
 * 
 * @Bean
 * 
 * @Primary public ElasticsearchOperations elasticsearchTemplate(final
 * JestClient jestClient, final ElasticsearchConverter elasticsearchConverter,
 * final SimpleElasticsearchMappingContext simpleElasticsearchMappingContext,
 * EntityMapper mapper) { return new JestElasticsearchTemplate(jestClient,
 * elasticsearchConverter, new
 ...
 * 
 * public CustomEntityMapper(ObjectMapper objectMapper) { this.objectMapper =
 * objectMapper;
